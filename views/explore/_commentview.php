...
<li style="border-radius: 3px;  margin-bottom: 0;
    ...
    <div style="margin-bottom: 15px;">
        <div style='display: inline-block; vertical-align: top;'>
            <a href="<?= Yii::$app->urlManager->createUrl(['//user/view', 'id' => $username]) ?>">
        ...
        <div style="display: inline-block; vertical-align: top; font-size: 14px; ">
            <a href="<?= Yii::$app->urlManager->createUrl(['//user/view', 'id' => $username]) ?>" style="display: block;"><?= Html::encode($model->user->name) ?></a>
