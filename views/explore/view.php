...
<?php if (Yii::$app->user->isGuest) : ?>
    <div id="slide-signup"
         style="position: fixed; bottom:-250px; transition: bottom 2s; width : 300px; z-index: 1000; border: 3px solid #3d8eb9; border-bottom: 0; right: 20px;">
        <div class="white text-center" style="height: 200px;">
            <div class="col-md-12">
                <a href="javascript:void(0);" onclick="$(this).parent().parent().parent().hide();" rel="nofollow"
