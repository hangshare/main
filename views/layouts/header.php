...
NavBar::begin([
    'brandLabel' => '<img src="http://www.hangshare.com/media/other/hangshare-logo.png" width="135" />',
...
<?php if (isset($this->params['prev'])) : ?>
    <div class="scroll-header">
        <div class="pull-left">
            <a href="/" class="navbar-brand"><img width="135" src="http://www.hangshare.com/media/other/hangshare-logo.png"></a>
            <h3><?= $this->title ?></h3>
        </div>
        <div class="pull-right marg">
            <ul class="list-inline">
                <?php if (isset($this->params['next'])) : ?>
                    <li><a class="btn btn-primary" href="<?php echo Yii::$app->urlManager->createAbsoluteUrl(['//explore/view', 'id' => $this->params['next']->id, 'title' => $this->params['next']->title]); ?>"><span class="pull-left"> الموضوع التالي</span><i class="fa fa-chevron-left pull-left"></i></a></li>
                <?php endif; ?>
                <li><a class="btn btn-primary js-share js-share-fasebook" post-url="<?php echo Url::current(['src' => null], true); ?>" href="javascript:void(0);"><i class="fa fa-fw fa-facebook" style="margin: 3px;"></i></a></li>
                <li><a style="color: #fff; background-color: #3E4347;" post-url="<?php echo Url::current(['src' => null], true); ?>" href="javascript:void(0);" class="btn js-share js-share-twitter"><i class="fa fa-twitter" style="margin: 3px;"></i></a></li>
                <li><a style="color: #fff; background-color: #e51717;" post-url="<?php echo Url::current(['src' => null], true); ?>" href="javascript:void(0);" class="btn js-share js-share-gpuls"><i class="fa fa-google-plus" style="margin: 3px;"></i></a></li>
            </ul>
        </div>
    </div>
<?php endif; ?>
