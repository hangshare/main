...
class Generator extends \yii\gii\Generator
{
    ...
    public $queryNs = 'frontend\models';
    public $queryClass;
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            'ns' => 'This is the namespace of the ActiveRecord class to be generated, e.g., <code>frontend\models</code>',
            ...
            'queryNs' => 'This is the namespace of the ActiveQuery class to be generated, e.g., <code>frontend\models</code>',
