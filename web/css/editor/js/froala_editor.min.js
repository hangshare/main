...
!function (a) {
    ...
    var b = function (c, d) {
        this.options = a.extend({}, b.DEFAULTS, a(c).data(), "object" == typeof d && d), this.valid_nodes = a.merge([], b.VALID_NODES), this.valid_nodes = a.merge(this.valid_nodes, a.map(Object.keys(this.options.blockTags), function (a) {
            ...
            for (var b = 1; b <= a.Editable.count; b++)
                b != this._id && a(window).trigger("blur." + b)
        }, this))
    };
    b.initializers = [], b.count = 0, b.VALID_NODES = ["P", "DIV", "LI", "TD", "TH"], b.LANGS = [], b.DEFAULTS = {allowedAttrs: ["accept", "accept-charset", "accesskey", "action", "align", "alt", "async", "autocomplete", "autofocus", "autoplay", "autosave", "background", "bgcolor", "border", "charset", "cellpadding", "cellspacing", "checked", "cite", "class", "color", "cols", "colspan", "contenteditable", "contextmenu", "controls", "coords", "data", "data-.*", "datetime", "default", "defer", "dir", "dirname", "disabled", "download", "draggable", "dropzone", "enctype", "for", "form", "formaction", "headers", "height", "hidden", "high", "href", "hreflang", "icon", "id", "ismap", "itemprop", "keytype", "kind", "label", "lang", "language", "list", "loop", "low", "max", "maxlength", "media", "method", "min", "multiple", "name", "novalidate", "open", "optimum", "pattern", "ping", "placeholder", "poster", "preload", "pubdate", "radiogroup", "readonly", "rel", "required", "reversed", "rows", "rowspan", "sandbox", "scope", "scoped", "scrolling", "seamless", "selected", "shape", "size", "sizes", "span", "src", "srcdoc", "srclang", "srcset", "start", "step", "summary", "spellcheck", "style", "tabindex", "target", "title", "type", "translate", "usemap", "value", "valign", "width", "wrap"], allowedTags: ["!--", "a", "abbr", "address", "area", "article", "aside", "audio", "b", "base", "bdi", "bdo", "blockquote", "br", "button", "canvas", "caption", "cite", "code", "col", "colgroup", "datalist", "dd", "del", "details", "dfn", "dialog", "div", "dl", "dt", "em", "embed", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hgroup", "hr", "i", "iframe", "img", "input", "ins", "kbd", "keygen", "label", "legend", "li", "link", "main", "map", "mark", "menu", "menuitem", "meter", "nav", "noscript", "object", "ol", "optgroup", "option", "output", "p", "param", "pre", "progress", "queue", "rp", "rt", "ruby", "s", "samp", "script", "section", "select", "small", "source", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "textarea", "tfoot", "th", "thead", "time", "title", "tr", "track", "u", "ul", "var", "video", "wbr"], alwaysBlank: !1, alwaysVisible: !1, autosave: !1, autosaveInterval: 1e4, beautifyCode: !0, blockTags: {n: "Normal", blockquote: "Quote", pre: "Code", h1: "Heading 1", h2: "Heading 2", h3: "Heading 3", h4: "Heading 4", h5: "Heading 5", h6: "Heading 6"}, buttons: ["bold", "italic", "underline", "strikeThrough", "fontSize", "fontFamily", "color", "sep", "formatBlock", "blockStyle", "align", "insertOrderedList", "insertUnorderedList", "outdent", "indent", "sep", "createLink", "insertImage", "insertVideo", "insertHorizontalRule", "undo", "redo", "html"], crossDomain: !0, convertMailAddresses: !0, customButtons: {}, customDropdowns: {}, customText: !1, direction: "ltr", disableRightClick: !1, editInPopup: !1, editorClass: "", formatTags: ["p", "pre", "blockquote", "h1", "h2", "h3", "h4", "h5", "h6", "div", "ul", "ol", "li", "table", "tbody", "thead", "tfoot", "tr", "th", "td"], headers: {}, height: "auto", icons: {}, inlineMode: !0, initOnClick: !1, language: "en_us", linkList: [], linkText: !1, linkClasses: {}, maxHeight: "auto", minHeight: "auto", noFollow: !0, paragraphy: !0, placeholder: "Type something", plainPaste: !1, preloaderSrc: "", saveURL: null, saveParams: {}, saveRequestType: "POST", simpleAmpersand: !1, shortcuts: !0, shortcutsAvailable: ["show", "bold", "italic", "underline", "createLink", "insertImage", "selectAll", "indent", "outdent", "html", "formatBlock n", "formatBlock h1", "formatBlock h2", "formatBlock h3", "formatBlock h4", "formatBlock h5", "formatBlock h6", "formatBlock blockquote", "formatBlock pre", "strikeThrough"], spellcheck: !1, theme: null, toolbarFixed: !0, trackScroll: !1, unlinkButton: !0, tabSpaces: !0, typingTimer: 500, pastedImagesUploadRequestType: "POST", pastedImagesUploadURL: "http://i.froala.com/upload_base64", width: "auto", withCredentials: !1, zIndex: 2e3}, b.prototype.destroy = function () {
        ...
        var c;
        if (b)
            for (c = a.replace(/<span((?!class\s*=\s*["']?f-marker["']?)[^>])*?><\/span>/gi, ""); a != c; )
                a = c, c = a.replace(/<span((?!class\s*=\s*["']?f-marker["']?)[^>])*?><\/span>/gi, "");
        else
            for (c = a.replace(/<span[^>]*?><\/span>/g, ""); a != c; )
                a = c, c = a.replace(/<span[^>]*?><\/span>/g, "");
        return a
        ...
        }, g = b.find(d); g.length && e === !1; )
            e = !0, g.each(f), g = b.find(d)
            ...
            this.options.pasteImage ? (0 === c.src.indexOf("data:") ? (this.options.defaultImageWidth && a(c).attr("width", this.options.defaultImageWidth), this.options.pastedImagesUploadURL && (setTimeout(a.proxy(function () {
                ...
                try {
                    if (b.link) {
                        ...
                        b.error ? this.throwImageErrorWithMessage(b.error) : this.throwImageError(2)
                } catch (e) {
        ...
        for (d = 0; d < a.length; d++)
            if (c = a.charAt(d), "<" == c) {
                ...
                if (-1 !== k) {
                    ...
                    if ("pre" === m && (j = n ? !1 : !0), this.isSelfClosingTag(l))
                        i.push("br" === m && j ? "\n" : l);
                    else if (n)
                        for (e = !1, f = !0; e === !1 && void 0 !== f; )
                            f = h.pop(), void 0 !== f && f.tag_name !== m ? i.splice(f.i, 1) : (e = !0, void 0 !== f && i.push(l));
                    else
                        i.push(l), h.push({tag_name: m, i: i.length - 1});
                    d = k
                }
            } else
                "\n" === c && this.options.beautifyCode ? b && j && i.push("<br/>") : "	" !== c && i.push(c);
        for (; h.length > 0; )
            f = h.pop(), i.splice(f.i, 1);
        var o = "\n";
        this.options.beautifyCode || (o = ""), a = "", h = 0;
        var p = !0;
        for (d = 0; d < i.length; d++)
            1 == i[d].length ? p && " " === i[d] || (a += i[d], p = !1) : g.indexOf(this.tagName(i[d]).toLowerCase()) < 0 ? a += i[d] : this.isSelfClosingTag(i[d]) ? a += i[d] : this.isClosingTag(i[d]) ? (h -= 1, 0 === h && (p = !0), a.length > 0 && a[a.length - 1] == o && (a += this.tabs(h)), a += i[d] + o) : (a += o + this.tabs(h) + i[d], h += 1);
        ...
        if (void 0 === c && (c = !1), void 0 === b && (b = !1), void 0 === d && (d = !0), this.$element.hasClass("f-placeholder") && !b)
            return"";
        if (this.isHTML)
        ...
        if (this.undoStack[this.undoIndex - 1] && this.removeMarkersByRegex(this.undoStack[this.undoIndex - 1]) == a)
            return!1;
        var b = !1;
        ...
        if (!this.isHTML) {
            ...
            if ("" === this.text() && c && (0 === c.startOffset || c.startContainer === this.$element.get(0) || !this.inEditor(c.startContainer))) {
                ...
                if (a.merge(["IMG", "BR"], this.valid_nodes).indexOf(this.getSelectionElement().tagName) < 0)
                    return!1;
                if (c.startOffset > 0 && this.valid_nodes.indexOf(this.getSelectionElement().tagName) >= 0 || c.startContainer && 3 === c.startContainer.nodeType)
                    return!1;
        ...
        for (var f, g, h = a("<div></div>").append(a(c).clone()).html(), i = [], j = {}, k = [], l = 0, m = 0; m < h.length; m++)
            if (g = h.charAt(m), "<" == g) {
                var n = h.indexOf(">", m + 1);
                if (-1 !== n) {
                    f = h.substring(m, n + 1);
                    ...
                    } else if (k.push(f), !this.isSelfClosingTag(f))
                        if (this.isClosingTag(f)) {
                            var s = j[o].pop();
                            i.splice(s, 1)
                        } else
                            i.push(f), void 0 === j[o] && (j[o] = []), j[o].push(i.length - 1)
                }
            } else
                l++, k.push(g);
        ...
        if (void 0 === c && (c = !0), !this.isHTML && c && this.focus(), this.removeMarkers(), this.insertSimpleHTML("<break></break>"), this.checkPlaceholder(!0), this.$element.hasClass("f-placeholder"))
            return this.$element.html(b), this.options.paragraphy && this.wrapText(!0), this.setFocusAtEnd(), this.checkPlaceholder(), !1;
        for (var d = a("<div>").append(b).find("*"), e = 0; e < d.length; e++)
            if (this.valid_nodes.indexOf(d[e].tagName) >= 0)
                return this.breakHTML(b), !1;
        ...
        if (this.pasting && !b)
            return!1;
        if (this.$element.find("td:empty, th:empty").append("</br>"), !this.isHTML)
        ...
        this.$bttn_wrapper.on(this.mousedown, ".fr-dropdown .fr-trigger:not([disabled])", function (b) {
            ...
            if (c.isDisabled)
                return!1;
            if (d.stopPropagation(), d.preventDefault(), !a(this).attr("data-down"))
        ...
        b.on(this.mousedown, "button[data-cmd], li[data-cmd], span[data-cmd], a[data-cmd]", function (b) {
            ...
            if ("touchmove" != b.type) {
                if (b.stopPropagation(), b.preventDefault(), !a(d).attr("data-down"))
                    return a("[data-down]").removeAttr("data-down"), !1;
                if (a("[data-down]").removeAttr("data-down"), a(d).data("dragging"))
    ...
    a.Editable.commands = {bold: {title: "Bold", icon: "fa fa-bold", shortcut: "(Ctrl + B)", refresh: a.Editable.prototype.refreshDefault, undo: !0, callbackWithoutSelection: function (a) {
        ...
        if (this.browser.msie && a.Editable.getIEversion() < 9)
            return"n" == b && (b = this.options.paragraphy ? "p" : "div"), document.execCommand("formatBlock", !1, "<" + b + ">"), this.triggerEvent("formatBlock"), !1;
        ...
        for (var f, g = function (a) {
            ...
            var i = a(e[h]);
            if (!this.fakeEmpty(i))
                if (f = "n" == b ? this.options.paragraphy ? a("<p>").html(i.html()) : i.html() + "<br/>" : a("<" + b + ">").html(i.html()), i.get(0) == this.$element.get(0) || g(f))
                    i.html(f);
                else {
                    var j = i.prop("attributes");
                    if (f.attr)
                        for (var k = 0; k < j.length; k++)
                            "class" !== j[k].name && f.attr(j[k].name, j[k].value);
                    var l;
                    this.options.blockStyles && this.options.blockStyles[b], void 0 === l && (l = this.options.defaultBlockStyle);
                    try {
                        if (i.hasClass(c) && i.get(0).tagName.toLowerCase() === b)
                            f.addClass(i.attr("class")).removeClass(c);
                        else {
                            if (void 0 === i.attr("class") || void 0 === l || !this.options.blockStylesToggle && "toggle" != d)
                                f.addClass(i.attr("class"));
                            else
        ...
        if (this.browser.msie && a.Editable.getIEversion() < 9)
            return document.execCommand(b, !1, !1), this.triggerEvent("align", [b]), !1;
        ...
        if (this.browser.msie && a.Editable.getIEversion() < 9)
            return b ? document.execCommand("outdent", !1, !1) : document.execCommand("indent", !1, !1), !1;
        var c = 20;
    ...
    a.Editable.prototype.markers_html = '<span class="f-marker" data-type="false" data-id="0" data-fr-verified="true"></span><span class="f-marker" data-type="true" data-id="0" data-fr-verified="true"></span>', a.Editable.prototype.text = function () {
        ...
        if (!this.selectionDisabled) {
            ...
            for (var a = this.getRanges(), b = 0; b < a.length; b++)
                if (a[b].startContainer !== document) {
                    var c = a[b];
    ...
    a.Editable.prototype.show = function (b) {
        ...
        for (var b = 1; b <= a.Editable.count; b++)
            b != this._id && a(window).trigger("hide." + b)
    ...
    a.Editable.prototype.getBoundingRect = function () {
        ...
        if (this.options.inlineMode || b) {
            if (c = this.getBoundingRect(), this.showBttnWrapper(), c.ok || c.left >= 0 && c.top >= 0 && c.right > 0 && c.bottom > 0)
                d = c.left + c.width / 2, e = c.top + c.height, this.iOS() && this.iOSVersion() < 8 || (d += a(window).scrollLeft(), e += a(window).scrollTop()), this.showByCoordinates(d, e);
    ...
    a.Editable.image_commands = {floatImageLeft: {title: "Float Left", icon: {type: "font", value: "fa fa-align-left"}}, floatImageNone: {title: "Float None", icon: {type: "font", value: "fa fa-align-justify"}}, floatImageRight: {title: "Float Right", icon: {type: "font", value: "fa fa-align-right"}}, linkImage: {title: "Insert Link", icon: {type: "font", value: "fa fa-link"}}, replaceImage: {title: "Replace Image", icon: {type: "font", value: "fa fa-exchange"}}, removeImage: {title: "Remove Image", icon: {type: "font", value: "fa fa-trash-o"}}}, a.Editable.DEFAULTS = a.extend(a.Editable.DEFAULTS, {allowedImageTypes: ["jpeg", "jpg", "png", "gif"], defaultImageTitle: "Image title", defaultImageWidth: 300, imageButtons: ["floatImageLeft", "floatImageNone", "floatImageRight", "linkImage", "replaceImage", "removeImage"], imageDeleteConfirmation: !0, imageDeleteURL: null, imageDeleteParams: {}, imageMove: !0, imageResize: !0, imageLink: !0, imageTitle: !0, imageUpload: !0, imageUploadParams: {}, imageUploadParam: "file", imageUploadToS3: !1, imageUploadURL: "http://i.froala.com/upload", maxImageSize: 10485760, pasteImage: !0, textNearImage: !0}), a.Editable.prototype.hideImageEditorPopup = function () {
            ...
            this.$image_wrapper.on("change", 'input[type="file"]', function () {
                if (void 0 !== this.files)
                    ...
                    if (b.options.imageUploadToS3 !== !1) {
                        ...
                        c.prepend('<input type="hidden" name="XHR_CORS_TRARGETORIGIN" value="' + window.location.href + '" />');
        ...
        var d = "";
        parseInt(this.options.defaultImageWidth, 10) && (d = ' width="auto"');
    ...
    a.Editable.DEFAULTS = a.extend(a.Editable.DEFAULTS, {allowedEmptyTags: ["table", "thead", "tbody", "tfoot", "tr", "th", "td", "a", "span", "iframe", "div", "object", "param", "embed", "video", "source", "i"], selfClosingTags: ["br", "button", "input", "img", "hr", "param", "!--", "source", "embed"]}), a.Editable.TAG_ORDER = ["main", "section", "header", "footer", "article", "details", "legend", "summary", "table", "thead", "tbody", "tfoot", "tr", "th", "td", "ul", "ol", "li", "h1", "h2", "h3", "h4", "h5", "h6", "pre", "blockquote", "p", "a", "strong", "em", "strike", "u", "span", "iframe", "object", "param", "video", "source", "embed"], a.Editable.prototype.isClosingTag = function (a) {
                ...
                if (-1 !== q) {
                    ...
                    if (r)
                        for (var y = 0; y < r.length; y++)
                            0 === r[y].indexOf("class=") && (x = r[y]), 0 === r[y].indexOf("style=") && r.splice(y, 1);
                    ...
                    if ("i" == g && (o = z ? !1 : !0), z) {
                        ...
                        this.valid_nodes.indexOf(g.toUpperCase()) >= 0 && (r ? r.push('data-fr-idx="' + p + '"') : r = ['data-fr-idx="' + p + '"']), j.push({type: g, attrs: r, style: t, start: h, i: i, original: e}), m[g] || (m[g] = []), m[g].push(j.length - 1);
                    p = q
                }
            } else {
                k += d, l[h] = {};
        ...
        for (p = 0; p < l.length; p++) {
            D[p] = {};
            for (var E in l[p])
                D[p][this.extendedKey(l[p][E])] = l[p][E]
        }
        ...
        for (var c, d = [], e = {}, f = 0; f < b.length; f++) {
            var g = b[f];
            for (c in e)
                g[c] || (e[c].end = f, d.push(a.extend({}, e[c])), delete e[c]);
            for (var h in g)
                e[h] || (g[h].start = f, e[h] = g[h])
        }
        for (c in e)
            e[c].end = b.length, d.push(e[c]);
        return d
        ...
        if (a.attrs) {
            a.attrs.sort();
            for (var c = 0; c < a.attrs.length; c++)
                b += " " + a.attrs[c]
        }
        var d = "";
        for (var e in a.style)
            null != a.style[e] && (d += e.replace("_", "-") + ": " + a.style[e] + "; ");
        ...
        for (e = 0; e < i.length; e++)
            d = i[e], l[d.start] || (l[d.start] = []), l[d.start].push(d);
        var m = {};
        for (b = "", e = 0; e <= k.length; e++) {
            ...
            if (l[e])
                for (l[e] = l[e].sort(this.sortNodes), f = 0; f < l[e].length; f++)
                    d = l[e][f], m[d.end] || (m[d.end] = []), m[d.end].push(d), b += this.openTag(d);
            if (j[e])
                for (j[e] = j[e].sort(this.sortSimpleTags), g = 0; g < j[e].length; g++)
                    b += j[e][g].content;
            e != k.length && (b += k[e])
        }
        return b
        ...
        if (d[0] != this.$element.get(0))
            ...
            0 === this.$element.find(this.valid_nodes.join(",")).length && (e = this.$element.html(), f = this.cleanOutput(e, c), f !== e && this.$element.html(f));
